!!!Important
    **Schema Update — June 23, 2026:** Settlement webhooks now include `isExpiration`, `isMulticlearing`, and `multiclearingClose` fields. See [Webhook Field Updates](./webhookFieldUpdates.en.md) for details.
